        ...
        for y_metric in y_metrics[trace_family]:
            ...
            for switch in per_switch_traces.keys():
                for period in PERIODS:
                    for name, func in functions:
                        ...
                        x_train, y_train = filter_agg_periodic(x_train, y_train, period, func)
            ...
            for period in PERIODS:
                for name, func in functions:
                    ...
                    x_train, y_train = filter_agg_periodic(x_train_original, y_train_original, period, func)
                    ...
                    minimal_dataset = selectK.fit_transform(x_train_original, y_train_original)
                    best_k.append(list(minimal_dataset.columns))

                    x_train, x_test, y_train, y_test = train_test_split(
                        minimal_dataset, y_train_original, test_size=TEST_SIZE, random_state=RANDOM_STATE)
