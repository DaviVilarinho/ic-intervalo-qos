...
def main(random_state=42):
    results_path = global_variables_experiment.get_base_results_path('replication/univariate')
    ...
    results_entry_columns = ['k_best', 'random_state'] + table_iv_columns
            ...
            for y_metric in global_variables_experiment.Y_METRICS[trace_family]:
                ...
                for k in range(20):
                    for regression_method in ['reg_tree', 'random_forest']:
                        ...
                        univariate_experiment = experiment.run_experiment(minimal_dataset, y, y_metric, random_state=random_state, regression_method=regression_method)
