...
x_files = ['X_cluster.csv']

x_trace = pd.DataFrame()

for x_file in x_files:
    read_dataset = pd.read_csv(f'{VOD_SINGLEAPP_PERIODIC_LOAD_PATH}/{x_file}', usecols=['TimeStamp', '4_kbcached'],
...
x_trace_minimal_reg_tree = x_trace
